...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **R1** | *Computer is too slow:* Training the AI model takes too long on a regular laptop, causing delays. | Resource | 4 | 4 | **16** | **Avoid:** Use Google Colab/Cloud GPUs. |
| **R2** | *Not enough face photos:* We might not find 10,000 quality images or they lack variety. | Technical | 3 | 5 | **15** | **Mitigate:** Use data augmentation (flip/rotate). |
| **R3** | *Video lag:* The AI takes too long (>500ms) to process video frames. | Technical | 3 | 4 | **12** | **Mitigate:** Resize images to lower resolution. |
...
- *Mitigation:* Switch from local laptop training to Google Colab (Free Tier) or Kaggle Kernels to utilize cloud GPUs.
- *Owner:* Angelo
